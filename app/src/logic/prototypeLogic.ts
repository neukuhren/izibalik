...
export class PrototypeLogic extends Logic {
  constructor(props) {
    ...
    const RAW = [
      ['pubgm', 'uc', 'p60', '60_uc', '60 UC', 0.8547, { uc: 60, old: 109, markup: 25 }],
      ['pubgm', 'uc', 'p325', '325_uc', '325 UC', 4.3826, { uc: 325, old: 519, badge: 'ПОПУЛЯРНЫЙ' }],
      ['pubgm', 'uc', 'p660', '660_uc', '660 UC', 8.6997, { uc: 660, old: 999 }],
      ['pubgm', 'uc', 'p1800', '1800_uc', '1800 UC', 21.9131, { uc: 1800, old: 2590, badge: 'ВЫГОДНО' }],
      ['pubgm', 'uc', 'p3850', '3850_uc', '3850 UC', 43.6825, { uc: 3850, old: 5290 }],
      ['pubgm', 'uc', 'p8100', '8100_uc', '8100 UC', 88.7733, { uc: 8100, old: 10490 }],
      ['pubgm', 'prime', 'pr1', 'prime_1_month', 'Прайм · 1 мес', 0.8455, { icon: 'P', iconBg: VI_G, iconC: '#fff' }],
      ['pubgm', 'prime', 'pr3', 'prime_3_months', 'Прайм · 3 мес', 2.5443, { icon: 'P', iconBg: VI_G, iconC: '#fff' }],
      ['pubgm', 'prime', 'pr6', 'prime_6_months', 'Прайм · 6 мес', 5.0887, { icon: 'P', iconBg: VI_G, iconC: '#fff' }],
      ['pubgm', 'prime', 'pr12', 'prime_12_months', 'Прайм · 12 мес', 10.1773, { icon: 'P', iconBg: VI_G, iconC: '#fff', badge: 'ВЫГОДНО' }],
      ['pubgm', 'prime', 'prp1', 'prime_plus_1_month', 'Прайм Плюс · 1 мес', 8.4784, { icon: 'P+', iconBg: VM_G, iconC: '#fff' }],
      ['pubgm', 'prime', 'prp3', 'prime_plus_3_months', 'Прайм Плюс · 3 мес', 25.4353, { icon: 'P+', iconBg: VM_G, iconC: '#fff' }],
      ['pubgm', 'prime', 'prp6', 'prime_plus_6_months', 'Прайм Плюс · 6 мес', 50.8707, { icon: 'P+', iconBg: VM_G, iconC: '#fff' }],
      ['pubgm', 'prime', 'prp12', 'prime_plus_12_months', 'Прайм Плюс · 12 мес', 101.7493, { icon: 'P+', iconBg: VM_G, iconC: '#fff', badge: 'ВЫГОДНО' }],
      ['pubgm', 'mythic', 'wme', 'weekly_mythic_emblem_value_pack', 'Мифические кристаллы · Weekly', 2.5834, { icon: '◆', iconBg: VM_G, iconC: '#fff', badge: 'ХИТ' }],
      ['pubgm', 'mythic', 'mep', 'mythic_emblem_pack', 'Мифические кристаллы · Pack', 4.2432, { icon: '◆', iconBg: CY_G, iconC: '#04202b' }],
      ['pubgm', 'other', 'ep50', 'elite_pass_lv1_50', 'Elite Pass · LV1–50', 4.7207, { icon: 'EP', iconBg: MG_G, iconC: '#fff' }],
      ['pubgm', 'other', 'ep100', 'elite_pass_lv1_100', 'Elite Pass · LV1–100', 9.4414, { icon: 'EP', iconBg: MG_G, iconC: '#fff' }],
      ['pubgm', 'other', 'epp100', 'elite_pass_plus_lv1_100', 'Elite Pass Plus · LV1–100', 23.5957, { icon: 'EP+', iconBg: VM_G, iconC: '#fff', badge: 'MAX' }],
      ['pubgm', 'other', 'fpp', 'first_purchase_pack', 'First Purchase Pack', 0.8455, { icon: 'FP', iconBg: CY_G, iconC: '#04202b' }],
      ['pubgm', 'other', 'wd1', 'weekly_deal_pack_1', 'Weekly Deal · Pack 1', 0.8611, { icon: 'W1', iconBg: VI_G, iconC: '#fff' }],
      ['pubgm', 'other', 'wd2', 'weekly_deal_pack_2', 'Weekly Deal · Pack 2', 2.5834, { icon: 'W2', iconBg: VI_G, iconC: '#fff' }],
      ['pubgm', 'other', 'ufm', 'upgradable_firearm_materials_pack', 'Материалы оружия · Pack', 2.5443, { icon: '⚙', iconBg: MG_G, iconC: '#fff' }],
    ...
    const P = RAW.map(([game, sub, id, offerId, name, buyUsd, x = {}]) => {
      const buy = Math.round(buyUsd * RUB);
      const markup = x.markup || 22;
      return {
        id, game, sub, offerId, name, buy, markup,
  ...
  priceOf(p) { return Math.round(p.buy * (1 + p.markup / 100)); }
  ...
  renderVals() {
    ...
    const prodRows = s.products.map(p => {
      ...
      return {
        name: p.name, buyF: this.fmt(p.buy), markup: p.markup, priceF: this.fmt(this.priceOf(p)),
