...
const RAW: Raw[] = [
  // buyUsd — актуальные price_usd FazerCards (pubg_mobile_auto), сверять tools/fetch-fazer-catalog.mjs
...
/** Каталог для витрины/админки: закуп в ₽ по текущему курсу Fazer. */
